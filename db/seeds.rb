...
n2 = Node.create(nodename: 'Node_1', ip: "10.0.1.8", containers: "3", cpu: "0 / 1", memory: "0 B / 1.021 GiB", docker_version: "1.11.2")
n3 = Node.create(nodename: 'Node_1', ip: "10.0.1.35", containers: "10", cpu: "0 / 2", memory: "0 B / 4.021 GiB", docker_version: "1.11.2")
n4 = Node.create(nodename: 'Node_1', ip: "10.0.1.124", containers: "40", cpu: "0 / 4", memory: "0 B / 8.021 GiB", docker_version: "1.11.2")
